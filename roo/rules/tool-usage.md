...
本文档是 roo 系统中关于工具使用的权威指南，为所有模式在任务执行过程中提供系统化的工具选择、应用策略及最佳实践。

---

## 第一部分：工具参考 (Tool Reference)

本部分详细介绍了 roo 系统中可用的所有工具及其核心功能。
...
## 第二部分：应用策略 (Application Strategy)

本部分提供了场景驱动的工具选择策略和经过验证的工具组合模式，旨在提升任务执行效率。
...
## 第三部分：实践指南 (Practices & Guidelines)

本部分包含性能优化建议、异常处理方法、最佳实践以及需要避免的反模式。
